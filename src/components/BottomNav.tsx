...
export const BottomNav: React.FC<BottomNavProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-slate-900/95 backdrop-blur-xl border-t border-slate-800/80 z-40 shadow-2xl">
      <div className="max-w-lg sm:max-w-xl lg:max-w-2xl mx-auto flex items-center px-1 sm:px-2 py-2 pb-safe">
        {tabs.map((tab) => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className="flex flex-1 min-w-0 flex-col items-center gap-1 py-1 px-1 rounded-2xl transition-all cursor-pointer"
            >
