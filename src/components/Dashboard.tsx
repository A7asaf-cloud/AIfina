        ...
        >
          <div className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-sm font-black text-white font-num">{fmtUSD(stockPortfolioVal + portfolioCash)}</div>
              {stockPortfolioGain !== 0 && (
                <div className={"text-[10px] font-bold font-num " + (stockPortfolioGain >= 0 ? "text-emerald-400" : "text-red-400")}>
                  {stockPortfolioGain >= 0 ? "+" : ""}{fmtUSD(stockPortfolioGain)} ({stockPortfolioCost > 0 ? ((stockPortfolioGain / stockPortfolioCost) * 100).toFixed(1) : "0"}%)
                </div>
              )}
            </div>
          </div>
